...
<div class="container">
        ...
        <div class="col-12">
            <form action="<?php echo e(route('home')); ?>" method="GET" class="d-flex">
                <div class="input-group">
                    <input type="text" name="search" class="form-control" placeholder="Tìm kiếm sản phẩm..." value="<?php echo e(request('search')); ?>">
    ...
    <div class="row mb-3">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('products.user')); ?>" class="text-decoration-none text-web">Xem tất cả <i class="fas fa-angle-right"></i></a>
            </div>
        </div>
    </div>

    <!-- Show search results if search is active -->
    <?php if(request('search') || request('category') || request('brand')): ?>
    <div class="row mb-3">
        <div class="col-12">
            <div class="alert alert-info">
                Kết quả tìm kiếm 
                <?php echo e(request('search') ? 'cho "' . request('search') . '"' : ''); ?>

                <?php echo e(request('category') ? ' trong danh mục "' . $categories->firstWhere('id', request('category'))->name . '"' : ''); ?>

                <?php echo e(request('brand') ? ' của thương hiệu "' . $brands->firstWhere('id', request('brand'))->name . '"' : ''); ?>

                <a href="<?php echo e(route('home')); ?>" class="float-end"><i class="fas fa-times"></i> Xóa bộ lọc</a>
            </div>
        </div>
    </div>
    <?php endif; ?>
                ...
                <div class="card border-0 shadow-sm h-100 position-relative product-card">
                    ...
                    <div class="card-body p-2">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="brand-badge text-muted"><?php echo e($product->brand->name); ?></span>
                        </div>
                        <h5 class="card-title product-title">
                            <a href="<?php echo e(route('product.show', $product)); ?>" class="text-decoration-none text-dark"><?php echo e($product->name); ?></a>
                        </h5>
                        <?php if($product->discount > 0): ?>
                        ...
                        <?php else: ?>
                            <div class="mb-2">
                                <span class="fw-bold fs-5"><?php echo e(number_format($product->price, 0, ',', '.')); ?> đ</span>
                            </div>
                        <?php endif; ?>
                        <a href="<?php echo e(route('product.show', $product)); ?>" class="btn btn-web btn-sm d-flex align-items-center justify-content-center">
                            Mua ngay 
                        </a>
                    </div>
                </div>
    ...
    <div class="row mt-4">
        <div class="col-12 d-flex justify-content-center">
            <?php echo e($featuredProducts->appends(request()->query())->links()); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-php3\example-app\resources\views/index.blade.php ENDPATH**/ ?>