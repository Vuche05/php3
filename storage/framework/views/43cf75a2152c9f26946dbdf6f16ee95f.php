...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="text-center mt-3">
                        <p>Đã có tài khoản? <a href="<?php echo e(route('login')); ?>" class="text-web">Đăng nhập</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-php3\example-app\resources\views/auth/register.blade.php ENDPATH**/ ?>