                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="value" name="value" value="<?php echo e(old('value')); ?>" min="0" step="0.01" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="min_order_amount" name="min_order_amount" value="<?php echo e(old('min_order_amount')); ?>" min="0">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="max_discount_amount" name="max_discount_amount" value="<?php echo e(old('max_discount_amount')); ?>" min="0">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="usage_limit" name="usage_limit" value="<?php echo e(old('usage_limit')); ?>" min="1">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        generateBtn.addEventListener('click', function() {
            fetch('<?php echo e(route("coupons.generate-code")); ?>')
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-php3\example-app\resources\views/coupons/create.blade.php ENDPATH**/ ?>