                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="value" name="value" value="{{ old('value', $coupon->value) }}" min="0" step="0.01" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="min_order_amount" name="min_order_amount" value="{{ old('min_order_amount', $coupon->min_order_amount) }}" min="0">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="max_discount_amount" name="max_discount_amount" value="{{ old('max_discount_amount', $coupon->max_discount_amount) }}" min="0">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <p class="mb-1"><strong>Đã sử dụng:</strong> {{ $coupon->used_count }} lần</p>
