        ...
        <div class="form-container" id="loginForm">
            ...
            <div class="text-center mt-3">
                ...
                <div class="d-flex justify-content-center gap-2">
                    ...
                    {{-- <a href="{{ route('auth.google') }}" class="btn btn-google social-btn w-100">
                        <i class="fas fa-google me-2"></i> Google
                    </a> --}}
                </div>
            </div>

            <div class="text-center mt-3">
                <a href="{{ route('register') }}" class="text-center mt-3 text-decoration-none text-muted">Chưa có tài khoản?
